...
const adminLinks = [
  ...
  { href: '/colaboradores', label: 'Colaboradores', icon: TeamIcon },
  { href: '/chat', label: 'Mensajes', icon: ChatIcon },
  { href: '/wallet', label: 'Billetera', icon: WalletIcon },
  { href: '/blog', label: 'Blog', icon: BookIcon },
  { href: '/reglas', label: 'Reglas', icon: ShieldIcon },
  { href: '/invitar', label: 'Invitar', icon: InviteIcon },
  { href: '/tutorial', label: 'Tutorial', icon: TutorialIcon },
